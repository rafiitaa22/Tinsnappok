...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "cc330033c1c56957b4023ce071175063ecfa9a7e"
            ParseMutableClientConfiguration.clientKey = "38a2a71c1e1de27c51f4ca5a0eddca30ef8a9738"
            ParseMutableClientConfiguration.server = "http://ec2-54-71-175-247.us-west-2.compute.amazonaws.com/parse"
        })
